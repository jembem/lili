...
RESOURCES += src/qt/lili.qrc src/qt/lili_locale.qrc

TRANSLATIONS += src/qt/locale/lili_bg.ts \
                src/qt/locale/lili_de.ts \
                src/qt/locale/lili_en.ts \
                src/qt/locale/lili_es.ts \
                src/qt/locale/lili_fi.ts \
                src/qt/locale/lili_fr.ts \
                src/qt/locale/lili_it.ts \
                src/qt/locale/lili_ja.ts \
                src/qt/locale/lili_pl.ts \
                src/qt/locale/lili_pt.ts \
                src/qt/locale/lili_ru.ts \
                src/qt/locale/lili_sk.ts \
                src/qt/locale/lili_sv.ts \
                src/qt/locale/lili_vi.ts \
                src/qt/locale/lili_zh_CN.ts \
                src/qt/locale/lili_zh_TW.ts
