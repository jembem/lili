...
In order to support loading of multiple wallets in lili-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lili.cpp.
...
Changes to lili.cpp
----------------------
lili.cpp is the entry point into lili-qt, and as such, will require some minor modifications to provide hooks for
