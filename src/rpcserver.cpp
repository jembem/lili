...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LILI features */
        {"lili", "masternode", &masternode, true, true, false},
        {"lili", "masternodelist", &masternodelist, true, true, false},
        {"lili", "mnbudget", &mnbudget, true, true, false},
        {"lili", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lili", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lili", "mnsync", &mnsync, true, true, false},
        {"lili", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lili", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lilid, or the -server option to lili-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lili-cli " + methodname + " " + args + "\n";
}
